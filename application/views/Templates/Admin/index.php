				...
				<div class="header-menu">
					<div class="header-left">
						...
						<div class="dropdown for-message">
							...
							<div class="dropdown-menu" aria-labelledby="message">
								...
								<a class="dropdown-item media" href="#">
									<span class="photo media-left"><img alt="avatar" src="<?= base_url() ?>templates/admin/images/avatar/1.jpg"></span>
								...
								<a class="dropdown-item media" href="#">
									<span class="photo media-left"><img alt="avatar" src="<?= base_url() ?>templates/admin/images/avatar/2.jpg"></span>
									<div class="message media-body">
								...
								<a class="dropdown-item media" href="#">
									<span class="photo media-left"><img alt="avatar" src="<?= base_url() ?>templates/admin/images/avatar/3.jpg"></span>
									<div class="message media-body">
								...
								<a class="dropdown-item media" href="#">
									<span class="photo media-left"><img alt="avatar" src="<?= base_url() ?>templates/admin/images/avatar/4.jpg"></span>
									<div class="message media-body">
					...
					<div class="user-area dropdown float-right">
						<a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<img class="user-avatar rounded-circle" src="<?= base_url() ?>templates/admin/images/admin.jpg" alt="User Avatar">
						</a>
					...
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted m-b-15">To make the tabs toggleable, add the <code>data-toggle="tab"</code> attribute to each link. Then add a <code>.tab-pane</code> class with a unique ID for every tab and wrap them inside a
								<code>&lt;div&gt;</code> element with class <code>.tab-content</code>. If you want the tabs to fade in and out when clicking on them, add the <code>.fade</code> class to <code>.tab-pane</code>:
							</p>
